...
var Generic = (function () {
    function Generic(_botTrainingService) {
        ...
        this.populateGroups();
        setTimeout(function () {
            jQuery('#block' + this.popBlockId).addClass("blockactive");
        }, 5000);
    }
    ...
    Generic.prototype.addGalleryCard = function () {
        this.galleryCard = new GalleryCard_1.GalleryCard("", "", "", "", "");
    };
    ...
    Generic.prototype.addCard = function (val) {
        if (val == 1) {
            ...
            this._botTrainingService.addResponseMessage(this.galleryCard, "gallery", this.popBlock._id).subscribe(function (a) {
                console.log(a);
                if (a.code == 200) {
                }
            });
    ...
    Generic.prototype.openGalleryImage = function () {
        jQuery('#galleryImage').click();
    };
    Generic.prototype.openSingleImage = function () {
        jQuery('#singleImage').click();
    };
    Generic.prototype.populateGalleryImage = function (event) {
        jQuery('#galleryImageDiv').show();
        jQuery('#galleryImageBtn').hide();
        var file = event.target.files[0];
        this._botTrainingService.getPictureUrl(file).subscribe(function (a) {
            if (a.code == 200) {
                console.log(a.data);
                jQuery('#galleryImageDiv').css("background-image", "url('" + a.data + "')");
            }
        });
    };
    Generic.prototype.populateSingleImage = function (event) {
        jQuery('#singleImageDiv').show();
        jQuery('#singleImageBtn').hide();
        var file = event.target.files[0];
        this._botTrainingService.getPictureUrl(file).subscribe(function (a) {
            if (a.code == 200) {
                console.log(a.data);
                jQuery('#singleImageDiv').css("background-image", "url('" + a.data + "')");
            }
        });
    };
    ...
    Generic = __decorate([
        core_1.Component({
            ...
            styles: [__webpack_require__("./src/app/generic/generic.component.scss")]
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof BotTrainingService_1.BotTrainingService !== 'undefined' && BotTrainingService_1.BotTrainingService) === 'function' && _a) || Object])
    ], Generic);
    return Generic;
    var _a;
}());
...
var GalleryCard = (function (_super) {
    ...
    function GalleryCard(_pictureUrl, _title, _description, _url, _cardAddButton) {
        _super.call(this);
...
var ImageCard = (function (_super) {
    ...
    function ImageCard(_pictureUrl) {
        _super.call(this);
        this.pictureUrl = _pictureUrl;
    }
...
var TextCard = (function (_super) {
    ...
    function TextCard(_text, _cardAddButton) {
        _super.call(this);
        this.text = _text;
        this.cardAddButton = _cardAddButton;
    }
...
var BotTrainingService = (function () {
    ...
    BotTrainingService.prototype.getPictureUrl = function (file) {
