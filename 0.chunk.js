...
var routes = [
    { path: '', component: layout_component_1.Layout, children: [
            ...
            { path: 'users', loadChildren: function () { return __webpack_require__.e/* System.import */(8).then(__webpack_require__.bind(null, "./src/app/users/users.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
            { path: 'generic', loadChildren: function () { return __webpack_require__.e/* System.import */(13).then(__webpack_require__.bind(null, "./src/app/generic/generic.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
...
var Sidebar = (function () {
    function Sidebar(config, el, router, location, _userService, storageService) {
        this._userService = _userService;
        this.$el = jQuery(el.nativeElement);
        this.config = config.getConfig();
        this.router = router;
    ...
    __decorate([
        WebStorage_1.SessionStorage(), 
        __metadata('design:type', String)
    ], Sidebar.prototype, "userId", void 0);
    Sidebar = __decorate([
        core_1.Component({
            selector: '[sidebar]',
            providers: [UsersService_1.UsersService, LocalStorageEmitter_1.LocalStorageService],
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof app_config_1.AppConfig !== 'undefined' && app_config_1.AppConfig) === 'function' && _a) || Object, (typeof (_b = typeof core_1.ElementRef !== 'undefined' && core_1.ElementRef) === 'function' && _b) || Object, (typeof (_c = typeof router_1.Router !== 'undefined' && router_1.Router) === 'function' && _c) || Object, (typeof (_d = typeof common_1.Location !== 'undefined' && common_1.Location) === 'function' && _d) || Object, (typeof (_e = typeof UsersService_1.UsersService !== 'undefined' && UsersService_1.UsersService) === 'function' && _e) || Object, (typeof (_f = typeof LocalStorageEmitter_1.LocalStorageService !== 'undefined' && LocalStorageEmitter_1.LocalStorageService) === 'function' && _f) || Object])
    ], Sidebar);
    return Sidebar;
